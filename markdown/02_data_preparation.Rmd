...
## Funções de modelo naive

``` {r RunNaiveModel, eval = FALSE}
...
``` {r GenerateNaiveTimeSeriesModel, eval = FALSE}
...
## Funções de modelos lineares

``` {r RunLinearTimeSeriesModel, eval = FALSE}
...
``` {r GenerateLinearTimeSeriesModels, eval = FALSE}
...
## Funções de suavização (MA)

``` {r RunMovingAverageTimeSeriesModel, eval = FALSE}
...
``` {r GenerateMovingAverageTimeSeriesModel, eval = FALSE}
...
## Funções de suavização exponencial

``` {r RunExponentialsmoothingStateTimeSeriesModel, eval = FALSE}
...
``` {r GenerateExponentialsmoothingStateTimeSeriesModel, eval = FALSE}
# this function generates and saves all linear time series models to the
# model's directory for later consuming
...
``` {r GenerateFitPlotGIF, eval = FALSE}
